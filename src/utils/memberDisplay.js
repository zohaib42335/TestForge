 ...
 * @param {string|null|undefined} storedActorName - Value from stored activity actor name
 * @returns {string}
 */
...
/**
 * Public name for a team row; never fall back to email for visible label.
